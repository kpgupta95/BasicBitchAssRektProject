...
int main(void) {
    ...
    HAL_GPIO_Init(LED_PORT, &gpioConfig);

    // 2. Force LED off initially (ST-LINK might have left it on)
    HAL_GPIO_WritePin(LED_PORT, LED_PIN, GPIO_PIN_SET);
    HAL_Delay(1000);  // Pause to show LED is on
    HAL_GPIO_WritePin(LED_PORT, LED_PIN, GPIO_PIN_RESET);
    HAL_Delay(1000);  // Pause to show reset
...
// Minimal clock config (adjust per your board)
void SystemClock_Config(void) {
